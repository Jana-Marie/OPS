...
//uint8_t MP8862_hardwarePowerUp(struct MP8862_t *_MP8862, uint8_t (*callback_set_enable_pin)(uint16_t ID, uint8_t state), uint16_t ID);
...
uint8_t MP8862_readCurrentLimit_mA(struct MP8862_t *_MP8862, uint16_t *restrict current_mA);
uint8_t MP8862_setVoltageSetpoint_mV(struct MP8862_t *_MP8862, uint16_t voltage_mV);
uint8_t MP8862_readVoltageSetpoint_mV(struct MP8862_t *_MP8862, uint16_t *restrict voltage_mV);
